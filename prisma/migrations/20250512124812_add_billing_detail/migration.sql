...
CREATE TABLE `billing_details` (
    ...
    `billingStatus` VARCHAR(191) NOT NULL DEFAULT 'pending',
...
-- AddForeignKey
ALTER TABLE `billing_details` ADD CONSTRAINT `billing_details_customerId_fkey` FOREIGN KEY (`customerId`) REFERENCES `customers`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
