/*
  ...
  - You are about to drop the column `amount` on the `billing_details` table. All the data in the column will be lost.
  - You are about to drop the column `billingStatus` on the `billing_details` table. All the data in the column will be lost.
  - You are about to drop the column `createdAt` on the `billing_details` table. All the data in the column will be lost.
  - You are about to drop the column `updatedAt` on the `billing_details` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `billing_details` DROP COLUMN `amount`,
